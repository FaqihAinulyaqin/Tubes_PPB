...
class _HalamanUtamaState extends State<HalamanUtama> {
  ...
  Future<void> _getProduk() async {
    try {
      final respon = await http.get(Uri.parse('http://llocalhost:3000/api/produk/getProduk'));
  ...
  Future<void> _getCategory() async {
    try {
      final respon = await http.get(Uri.parse('http://llocalhost:3000/api/produk/getCategory'));
      if (respon.statusCode == 200) {
        final data = jsonDecode(respon.body);
        setState(() {
  ...
  Future<void> _getProdukByCategory(String category) async {
    ...
    try {
      final respon = await http.get(Uri.parse('http://llocalhost:3000/api/produk/getProduk/$category'));
      if (respon.statusCode == 200) {
        final data = jsonDecode(respon.body);
        setState(() {
          products = List<Map<String, dynamic>>.from(data['data']);
